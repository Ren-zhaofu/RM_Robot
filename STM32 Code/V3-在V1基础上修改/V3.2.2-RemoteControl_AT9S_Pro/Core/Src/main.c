...
//  HAL_UART_Receive_IT(&UARTX_Handle, Receive_Data.Receive_Data_Buf, SEND_DATA_SIZE);
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
    RC_AT9S_Pro_Control(RC_AT9S_PRO_Data.RC_AT9S_PRO_CH1, RC_AT9S_PRO_Data.RC_AT9S_PRO_CH2, RC_AT9S_PRO_Data.RC_AT9S_PRO_CH3, RC_AT9S_PRO_Data.RC_AT9S_PRO_CH4);
    HAL_Delay(10);
  }
  /* USER CODE END 3 */
}
