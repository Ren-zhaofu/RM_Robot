...
Send_Data_TypeDef Send_Data_Tran(void)
{
  ...
  if(JY901S_ucRxBuffer[0] == 0x55)
  {
    ...
    {
      Send_Data_Temp.Send_Data_Buf[18] = JY901S_ucRxBuffer[2];
      Send_Data_Temp.Send_Data_Buf[19] = JY901S_ucRxBuffer[3];
      Send_Data_Temp.Send_Data_Buf[20] = JY901S_ucRxBuffer[4];
      Send_Data_Temp.Send_Data_Buf[21] = JY901S_ucRxBuffer[5];
      Send_Data_Temp.Send_Data_Buf[22] = JY901S_ucRxBuffer[6];
      Send_Data_Temp.Send_Data_Buf[23] = JY901S_ucRxBuffer[7];
    }
    else
    {
