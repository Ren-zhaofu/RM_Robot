...
/* Private defines -----------------------------------------------------------*/
#define JY901S_UART8_TX_Pin GPIO_PIN_1
#define JY901S_UART8_TX_GPIO_Port GPIOE
#define JY901S_UART8_RX_Pin GPIO_PIN_0
#define JY901S_UART8_RX_GPIO_Port GPIOE
...
#define RC_AT9S_Pro_SBUS_Pin GPIO_PIN_7
#define RC_AT9S_Pro_SBUS_GPIO_Port GPIOB
...
#define UWB_UART7_TX_Pin GPIO_PIN_8
#define UWB_UART7_TX_GPIO_Port GPIOE
...
#define UWB_UART7_RX_Pin GPIO_PIN_7
#define UWB_UART7_RX_GPIO_Port GPIOE
