...
#define RC_PS2_CLK_Pin GPIO_PIN_4
#define RC_PS2_CLK_GPIO_Port GPIOE
#define RC_PS2_CS_Pin GPIO_PIN_5
#define RC_PS2_CS_GPIO_Port GPIOE
...
#define RC_PS2_DO_Pin GPIO_PIN_0
#define RC_PS2_DO_GPIO_Port GPIOF
#define Power1_Pin GPIO_PIN_2
#define Power1_GPIO_Port GPIOH
#define Power2_Pin GPIO_PIN_3
#define Power2_GPIO_Port GPIOH
#define RC_PS2_DI_Pin GPIO_PIN_1
#define RC_PS2_DI_GPIO_Port GPIOF
