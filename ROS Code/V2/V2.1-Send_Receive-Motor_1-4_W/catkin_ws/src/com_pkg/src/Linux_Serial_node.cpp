...
int main(int argc, char *argv[])
{
  ...
  {
    // ros::spinOnce();
    // if (receiveData(Linux_Serial, Receive_Data.Receive_Data_Buf, RECEIVE_BUF_SIZE))
    // {
    ...
    Send_Data = Send_Data_Tran(Robot_Parameters.Motor_M3508_ID01_W, Robot_Parameters.Motor_M3508_ID02_W, Robot_Parameters.Motor_M3508_ID03_W, Robot_Parameters.Motor_M3508_ID04_W);
