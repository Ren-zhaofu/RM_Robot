...
// (in-package robomaster_msgs.msg)
...
class robomaster {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float32(obj.Motor_M3508_ID01_W, buffer, bufferOffset);
    // Serialize message field [Motor_M3508_ID02_W]
    bufferOffset = _serializer.float32(obj.Motor_M3508_ID02_W, buffer, bufferOffset);
    // Serialize message field [Motor_M3508_ID03_W]
    bufferOffset = _serializer.float32(obj.Motor_M3508_ID03_W, buffer, bufferOffset);
    // Serialize message field [Motor_M3508_ID04_W]
    bufferOffset = _serializer.float32(obj.Motor_M3508_ID04_W, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new robomaster(null);
    // Deserialize message field [Motor_M3508_ID01_W]
    data.Motor_M3508_ID01_W = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [Motor_M3508_ID02_W]
    data.Motor_M3508_ID02_W = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [Motor_M3508_ID03_W]
    data.Motor_M3508_ID03_W = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [Motor_M3508_ID04_W]
    data.Motor_M3508_ID04_W = _deserializer.float32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.Motor_M3508_ID02_W !== undefined) {
      ...
      resolved.Motor_M3508_ID02_W = 0.0
    }
    ...
    if (msg.Motor_M3508_ID03_W !== undefined) {
      ...
      resolved.Motor_M3508_ID03_W = 0.0
    }
    ...
    if (msg.Motor_M3508_ID04_W !== undefined) {
      ...
      resolved.Motor_M3508_ID04_W = 0.0
    }
